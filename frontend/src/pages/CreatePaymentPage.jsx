                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500">
                    {formatPeriod(
                      ...
                      payslip.payRun?.periodEnd || payslip.payRun?.endDate
                    )}
                  </div>
                </div>
                <div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                  {paymentMethods.map((method) => (
                    <label
                      key={method.value}
                      className={`flex items-center gap-3 text-sm border rounded-lg p-2 cursor-pointer transition-colors ${
                    ...
                    >
                      <input
                        ...
                        className="sr-only"
                      />
                      <span className="text-lg w-8 flex items-center justify-center">
                        {method.icon}
                      </span>
