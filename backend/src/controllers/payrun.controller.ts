...
class PayRunController {
  ...
  async create(req: Request, res: Response) {
    try {
      ...
      sendResponse(
        res,
        HttpStatus.CREATED,
        "Cycle de paie créé avec succès",
        payRun
      );
    } catch (error: any) {
      ...
      sendResponse(
        ...
        error.message || "Erreur lors de la création du cycle de paie"
      );
    }
  }
  ...
  async getByCompany(req: Request, res: Response) {
    try {
      ...
      const result = await payRunService.getByCompany(companyId, {
        page: Number(page),
        limit: Number(limit),
      ...
      sendResponse(
        res,
        HttpStatus.OK,
        "Cycles de paie récupérés avec succès",
        result
      );
    } catch (error: any) {
      console.error(
        "Erreur lors de la récupération des cycles de paie:",
        error
      );
      sendResponse(
        res,
        HttpStatus.INTERNAL_SERVER_ERROR,
        error.message || "Erreur lors de la récupération des cycles de paie"
      );
    }
  }
  ...
  async getById(req: Request, res: Response) {
    try {
      ...
      sendResponse(
        res,
        HttpStatus.OK,
        "Cycle de paie récupéré avec succès",
        payRun
      );
    } catch (error: any) {
      ...
      sendResponse(
        res,
        HttpStatus.INTERNAL_SERVER_ERROR,
        error.message || "Erreur lors de la récupération du cycle de paie"
      );
    }
  }
  ...
  async update(req: Request, res: Response) {
    try {
      ...
      sendResponse(
        res,
        HttpStatus.OK,
        "Cycle de paie mis à jour avec succès",
        payRun
      );
    } catch (error: any) {
      ...
      sendResponse(
        res,
        HttpStatus.BAD_REQUEST,
        error.message || "Erreur lors de la mise à jour du cycle de paie"
      );
    }
  }
  ...
  async delete(req: Request, res: Response) {
    try {
      ...
      sendResponse(
        res,
        HttpStatus.BAD_REQUEST,
        error.message || "Erreur lors de la suppression du cycle de paie"
      );
    }
  }
  ...
  async approve(req: Request, res: Response) {
    try {
      ...
      sendResponse(
        res,
        HttpStatus.BAD_REQUEST,
        error.message || "Erreur lors de l'approbation du cycle de paie"
      );
    }
  }
